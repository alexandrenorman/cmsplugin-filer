...
class FilerVideo(CMSPlugin):
    ...
    movie_url = models.CharField(
        ...
        max_length=255,
        help_text=_(
            "vimeo or youtube (embeddable!) video url. Example: https://www.youtube.com/embed/dd4D8tZPfKE"
        ),
        blank=True,
        null=True,
    )
    ...
    width_units = models.CharField(
        ...
        default=settings.VIDEO_UNITS,
    )
    height = models.PositiveSmallIntegerField(
        _("height"), default=settings.VIDEO_HEIGHT
    )
    ...
    preload = models.CharField(
        ...
        default=settings.VIDEO_PRELOAD,
    )
